...
for(i=0;i<document.adminForm.id_carte.length;i++)
{
if(document.adminForm.id_carte[i].checked == true)
{var cochee = 1; break;}
else {var cochee = 0;}
}
if(cochee == 0)
{alert("Veuillez séléctionner une carte!");
return false;} 
...
case 'edit':
document.adminForm.method = "post";
document.adminForm.action = "edit01.php";
document.adminForm.submit();
break;
