...
mkdir('/var/www/cartes/cartes/'.$id, 0777, true);
...
if($_FILES['pdfa0']['size'] > 0) {$pdfa0_up=upload('pdfa0',$pdfa0_destination,$maxsize,$extension_pdf);if ($pdfa0_up){ $pdfa0_etat="ok";carte_has_format($id,0,PDF,$_FILES['pdfa0']['size']);} else{$pdfa0_etat="no";}} else{$pdfa0_etat="manquant";}
if($_FILES['pdfa1']['size'] > 0) {$pdfa1_up=upload('pdfa1',$pdfa1_destination,$maxsize,$extension_pdf);if ($pdfa1_up){ $pdfa1_etat="ok";carte_has_format($id,1,PDF,$_FILES['pdfa1']['size']);} else{$pdfa1_etat="no";}} else{$pdfa1_etat="manquant";}
if($_FILES['pdfa2']['size'] > 0) {$pdfa2_up=upload('pdfa2',$pdfa2_destination,$maxsize,$extension_pdf);if ($pdfa2_up){ $pdfa2_etat="ok";carte_has_format($id,2,PDF,$_FILES['pdfa2']['size']);} else{$pdfa2_etat="no";}} else{$pdfa2_etat="manquant";}
if($_FILES['pdfa3']['size'] > 0) {$pdfa3_up=upload('pdfa3',$pdfa3_destination,$maxsize,$extension_pdf);if ($pdfa3_up){ $pdfa3_etat="ok";carte_has_format($id,3,PDF,$_FILES['pdfa3']['size']);} else{$pdfa3_etat="no";}} else{$pdfa3_etat="manquant";}
if($_FILES['pdfa4']['size'] > 0) {$pdfa4_up=upload('pdfa4',$pdfa4_destination,$maxsize,$extension_pdf);if ($pdfa4_up){ $pdfa4_etat="ok";carte_has_format($id,4,PDF,$_FILES['pdfa4']['size']);} else{$pdfa4_etat="no";}} else{$pdfa4_etat="manquant";}

if($_FILES['jpga0']['size'] > 0) {$jpga0_up=upload('jpga0',$jpga0_destination,$maxsize,$extension_jpg);if ($jpga0_up){ $jpga0_etat="ok";carte_has_format($id,0,JPG,$_FILES['jpga0']['size']);} else{$jpga0_etat="no";}} else{$jpga0_etat="manquant";}
if($_FILES['jpga1']['size'] > 0) {$jpga1_up=upload('jpga1',$jpga1_destination,$maxsize,$extension_jpg);if ($jpga1_up){ $jpga1_etat="ok";carte_has_format($id,1,JPG,$_FILES['jpga1']['size']);} else{$jpga1_etat="no";}} else{$jpga1_etat="manquant";}
if($_FILES['jpga2']['size'] > 0) {$jpga2_up=upload('jpga2',$jpga2_destination,$maxsize,$extension_jpg);if ($jpga2_up){ $jpga2_etat="ok";carte_has_format($id,2,JPG,$_FILES['jpga2']['size']);} else{$jpga2_etat="no";}} else{$jpga2_etat="manquant";}
if($_FILES['jpga3']['size'] > 0) {$jpga3_up=upload('jpga3',$jpga3_destination,$maxsize,$extension_jpg);if ($jpga3_up){ $jpga3_etat="ok";carte_has_format($id,3,JPG,$_FILES['jpga3']['size']);} else{$jpga3_etat="no";}} else{$jpga3_etat="manquant";}
if($_FILES['jpga4']['size'] > 0) {$jpga4_up=upload('jpga4',$jpga4_destination,$maxsize,$extension_jpg);if ($jpga4_up){ $jpga4_etat="ok";carte_has_format($id,4,JPG,$_FILES['jpga4']['size']);} else{$jpga4_etat="no";}} else{$jpga4_etat="manquant";}

if($_FILES['vignette']['size'] > 0) {$vignette_up=upload('vignette',$vignette_destination,$maxsize,$extension_jpg);if ($vignette_up){ $vignette_etat="ok";darkroom($vignette_destination,$vignetteg_destination, $width = 630, $height = 420);darkroom($vignette_destination,$vignettep_destination, $width = 135, $height = 90);} else{$vignette="no";}} else{$vignette_etat="manquant";}
