...
$description_carte=strip_tags(stripslashes($a_requete["description_carte"]));

$commentaires_carte=strip_tags(stripslashes($a_requete["commentaires_carte"]));

$prestation_carte=stripslashes($a_requete["prestation_carte"]);

$creation_carte=$a_requete["creation_carte"];
/*$creation_carte= explode(" ", $creation_carte );
$creation_carte=explode("-", $creation_carte[0] );;
$creation_carte="$creation_carte[2]/$creation_carte[1]/$creation_carte[0]";*/

$sql_thematique = "SELECT * FROM carte_has_thematique INNER JOIN carte ON carte.id_carte=carte_has_thematique.id_carte WHERE carte.id_carte =$id_carte"; 
...
$carte_has_theme=$thema_requete["id_sousthematique"];

$sql_tag="SELECT * FROM carte_has_tags INNER JOIN carte ON carte_has_tags.id_carte=carte.id_carte INNER JOIN tags ON carte_has_tags.id_tags=tags.id_tags
WHERE carte.id_carte =$id_carte";
...
Edition d'une carte  : étape 1/2</div>
...
<tr>
				...
				<td width="573"><input name="titre" type="text" class="text_area" value="<?php echo $nom_carte;?>" size="50" /></td>
</tr>		
...
$nom_soustheme=stripslashes($a_req_ssrubrique["nom_soustheme"]);
	...
	echo"<option value='$id_theme-$id_soustheme'"; if($carte_has_theme==$id_soustheme){echo"selected";} echo">$nom_soustheme</option>";
...
?>     
	...
	<tr>
				...
				<td width="573"><input type="text" id="datepicker" name="date" value="<?php echo $creation_carte; ?>"></td>
</tr>
<tr>
				<td width="218" valign="top" class="key"><span class="editlinktip hasTip">Description</span></td>
				<td width="573"><textarea name="description" rows="8" cols="80"><?php echo $description_carte;?></textarea></td>
</tr>	
	<tr>
				<td width="218" valign="top" class="key"><span class="editlinktip hasTip">Prestation correspondante</span></td>
				<td width="573"><input name="prestation" type="text" class="text_area" value="<?php echo $prestation_carte;?>" size="50" /></td>
</tr>		
...
for ($i = 1; $i <= 10; $i++) {
    ...
    echo "<div class=\"line\"> <input id=\"tag$i\" name=\"tag$i\" value=\"$nom_tag\"> - &nbsp;</div>";
}
?> 
	...
	<tbody>
	<tr>
			<td width="300"><textarea name="commentaire" rows="8" cols="80"><?php echo $commentaires_carte;?></textarea></td>
