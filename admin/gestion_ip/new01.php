...
Nouvelle adresse Ip autorisée</div>
	...
	<legend>Adresse Ip
		...
		<tbody>
			...
			<tr>
				...
				<td width="573"><input name="ip_adresse" type="text" class="text_area" value="" size="50" /></td>
				</tr>
<tr>
				<td width="218" valign="top" class="key"><span class="editlinktip hasTip">Description</span></td>
				<td width="573"><input name="description_ip_adresse" type="text" class="text_area" value="" size="50" /></td>
				</tr>
