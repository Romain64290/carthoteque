	...
	<legend>Mot clé
		...
		<tbody>
			...
			<tr>
				...
				<td width="573"><input name="titre" type="text" class="text_area" value="<?php echo $nom_tag; ?>" size="50" /></td>
				</tr>
        ...
        <input name="id_tags" type="hidden" value="<?php echo $id_tags; ?>">
