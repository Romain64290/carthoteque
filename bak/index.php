...
<!-- Ligne 1 -->
	<div class="row">
		<div class="col s12 m6 l4"><p>
			...
			<a class='dropdown-button btn blue darken-1' href='#' data-activates='dropdown1'><?php echo $menu[1]; ?></a>
			 <!-- Dropdown Structure -->
...
?>
		...
		<div class="col s12 m6 l4"><p>
			      <i class="medium material-icons">directions_walk</i><br>
					...
					<a class='dropdown-button btn green darken-1' href='#' data-activates='dropdown2'><?php echo $menu[2]; ?></a>
...
?>
		...
		<div class="col s12 m6 l4"><p>
			      <i class="medium material-icons">nature_people</i><br>
					...
					<a class='dropdown-button btn lime darken-1' href='#' data-activates='dropdown3'><?php echo $menu[3]; ?></a>
...
<!-- Ligne 2 -->			
		...
		<div class="col s12 m6 l4"><p>
			...
			<a class='dropdown-button btn yellow darken-2' href='#' data-activates='dropdown1b'><?php echo $menu[4]; ?></a>
...
?>
			     ...
			     <i class="medium material-icons">share</i><br>
					<!-- Dropdown Trigger Ligne 2/Colonne 2-->
					<a class='dropdown-button btn deep-orange accent-3' href='#' data-activates='dropdown2b'><?php echo $menu[5]; ?></a>
...
?>
		...
		<div class="col s12 m6 l4"><p>
			      <i class="medium material-icons">people</i><br>
					<!-- Dropdown Trigger Ligne 2/Colonne 3-->
					<a class='dropdown-button btn brown darken-1' href='#' data-activates='dropdown3b'><?php echo $menu[6]; ?></a>
...
<!-- Ligne 3 -->
		...
		<div class="col s12 m6 l4"><p>
			...
			<a class='dropdown-button btn pink darken-1' href='#' data-activates='dropdown1c'><?php echo $menu[7]; ?></a>
...
<!-- Tags 1ère ligne -->
				<a href="recherche.php?tag=<?php echo $id_tag[1]; ?>" class="waves-effect waves-light blue lighten-1 btn-large"><?php echo $nom_tag[1]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[2]; ?>" class="waves-effect waves-light blue lighten-1 btn-large"><?php echo $nom_tag[2]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[3]; ?>" class="waves-effect waves-light blue lighten-1 btn-large"><?php echo $nom_tag[3]; ?></a><br>
<!-- Tags 2ème ligne -->
				<a href="recherche.php?tag=<?php echo $id_tag[4]; ?>" class="waves-effect waves-light blue lighten-2 btn"><?php echo $nom_tag[4]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[5]; ?>" class="waves-effect waves-light blue lighten-2 btn"><?php echo $nom_tag[5]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[6]; ?>" class="waves-effect waves-light blue lighten-2 btn"><?php echo $nom_tag[6]; ?></a><br>
<!-- Tags 3ème ligne -->				
				<a href="recherche.php?tag=<?php echo $id_tag[7]; ?>" class="waves-effect waves-light blue lighten-3 btn"><?php echo $nom_tag[7]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[8]; ?>" class="waves-effect waves-light blue lighten-3 btn"><?php echo $nom_tag[8]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[9]; ?>" class="waves-effect waves-light blue lighten-3 btn"><?php echo $nom_tag[9]; ?></a><br>
<!-- Tags 4ème ligne -->
				<a href="recherche.php?tag=<?php echo $id_tag[10]; ?>" class="waves-effect waves-light blue lighten-4 btn"><?php echo $nom_tag[10]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[11]; ?>" class="waves-effect waves-light blue lighten-4 btn"><?php echo $nom_tag[11]; ?></a>
				<a href="recherche.php?tag=<?php echo $id_tag[12]; ?>" class="waves-effect waves-light blue lighten-4 btn"><?php echo $nom_tag[12]; ?></a>
		</div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  _paq.push(["setCookieDomain", "*.cartes.agglo-pau.net"]);
  _paq.push(['trackPageView']);
  _paq.push(['enableLinkTracking']);
  (function() {
    var u="//stats.agglo-pau.net/";
...
<noscript><p><img src="//stats.agglo-pau.net/piwik.php?idsite=6" style="border:0;" alt="" /></p></noscript>
<!-- End Piwik Code -->
